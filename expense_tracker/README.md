...
- Undo a transaction: provide a valid index number then click the Undo button.
- Export transactions to a CSV file: input a valid file name and then click the Get CSV button.
